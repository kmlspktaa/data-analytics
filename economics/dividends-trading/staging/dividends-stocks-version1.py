...
class DividendAnalyzer:
    ...
    def process_dividend_data(self):
        self.df = self.spark.createDataFrame(self.fetch_dividend_data())
        ...
        return self.total_dividends.toPandas()

    def analyze_dividends(self):
        pandas_df = self.process_dividend_data()
        pandas_df.to_excel(self.output_file, index=False)


dividend_analyzer = DividendAnalyzer("symbols.csv", "dividend_data_2022_2023.xlsx")
